...
class TMSTrainConfig(BaseModel):
    ...
    def validate_model(self) -> Self:
        ...
        if (
            self.fixed_identity_hidden_layers or self.fixed_random_hidden_layers
        ) and self.tms_model_config.n_hidden_layers == 0:
            raise ValueError(
                "Cannot set fixed_identity_hidden_layers or fixed_random_hidden_layers to True if n_hidden_layers is 0"
            )
